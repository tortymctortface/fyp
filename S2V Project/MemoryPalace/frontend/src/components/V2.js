        ...
        <Grid container spacing = {1}>
            ...
            <Grid item xs={12} align="center">
                <FormControl>
                    ...
                    />
                    <FormHelperText>
                        <div align="center">Similarity to preceeding word weight</div>
                    </FormHelperText>
                    <HtmlTooltip
                        title={
                            <React.Fragment>
                            <Typography color="inherit">Enter a value between 0.00 and 0.99. This will determine how similar should each trigger word be to the chosen trigger word for the previous word to remember.</Typography>
                        </React.Fragment>
                        }
                        >
                        <Button>?</Button>
